                  ...
                  <div className="grid lg:grid-cols-2 gap-0">
                    ...
                    <div className="p-8">
                      <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            ...
                            <Badge variant="secondary">{case_.service}</Badge>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center p-4 bg-secondary/5 rounded-lg">
                            <div className="text-2xl font-bold text-secondary">+{case_.results.traffic}%</div>
                            <div className="text-sm text-muted-foreground">Tráfico Web</div>
                          </div>
                          <div className="text-center p-4 bg-secondary/5 rounded-lg">
                            <div className="text-2xl font-bold text-secondary">+{case_.results.leads}%</div>
                      ...
                      <div className="border-t border-border pt-4">
                        ...
                        <blockquote className="text-muted-foreground italic text-sm mb-3">
                    ...
                    {case_.website && (
                      <div className="bg-gradient-to-br from-card to-background p-8 border-l border-border">
                        <div className="text-center mb-6">
                          <h4 className="text-xl font-bold text-foreground mb-2">Sitio Web Desarrollado</h4>
                          <p className="text-sm text-muted-foreground">Diseño moderno y responsive</p>
                        </div>
                        ...
                        <a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="relative h-80 flex items-center justify-center mb-6 group cursor-pointer block"
                        >
                          {/* Desktop - Imagen principal más alta */}
                          <div className="relative w-4/5 h-60 bg-white rounded-2xl overflow-hidden shadow-2xl z-10 transition-all duration-300 ease-out group-hover:scale-105 group-hover:shadow-3xl group-hover:-translate-y-2">
                            <Image
                          ...
                          <div className="absolute bottom-8 right-8 w-24 h-48 bg-white rounded-xl overflow-hidden shadow-xl border-4 border-white z-20 transition-all duration-300 ease-out group-hover:scale-110 group-hover:shadow-2xl group-hover:-translate-y-1 group-hover:rotate-2">
                            <Image
                          ...
                          <div className="absolute inset-0 bg-gradient-to-br from-secondary/10 via-transparent to-accent/10 rounded-3xl -z-10 transition-all duration-300 ease-out group-hover:from-secondary/20 group-hover:to-accent/20"></div>
                          
                          {/* Overlay de hover con efecto de brillo */}
                          <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-white/5 to-white/10 rounded-3xl opacity-0 transition-opacity duration-300 ease-out group-hover:opacity-100 -z-5"></div>
                          
                          {/* Indicador de click */}
                          <div className="absolute top-4 right-4 bg-primary/90 text-primary-foreground px-3 py-1 rounded-full text-sm font-medium opacity-0 transform translate-y-2 transition-all duration-300 ease-out group-hover:opacity-100 group-hover:translate-y-0 z-30">
                            Ver sitio web
                          </div>
                        </a>
                        ...
                        <div className="text-center">
                          <p className="text-sm text-muted-foreground">
                            Haz clic en las imágenes para visitar: <span className="font-medium text-foreground">{case_.website}</span>
                          </p>
                        </div>
                      </div>
                    )}
